...
<html class="loading">
  ...
  <div class="content-body">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>Unknown-Checker</strong></h4> 
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://ART_OF_WORKING.t.me">CLICK HERE TO OWNER  @ART_OF_WORKING </a> <br>
    ...
    <option </option>
	            <option style="background:rgba(165, 154, 154, 0.281);color:rgb(255, 208, 0);color:white" value="gate/chk.php">Unknown Checker</option>
...
Swal.fire({ title: "@ART_OF_WORKING", text: "Join Our Telegram Channel :)", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
...
if(total > 500000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO <499999', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
